const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-07-21', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '产品经理入门', url: '/tag/产品经理入门' },
  HEO_HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HEO_HERO_CATEGORY_3: { title: '站点推荐', url: '/tag/站点推荐' },
  ...
  HEO_INFO_CARD_ICON2: 'fa-solid fa-circle-user',
  ...
  HEO_SOCIAL_CARD_TITLE_3: 'https://img.remit.ee/api/file/BQACAgUAAyEGAASHRsPbAAEDCMto2hvKjs6RLX0TAAEFBQ72x8C3FToAAvYeAAIGudBW2mLWZfawK8Y2BA.jpg',
