...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Shuai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的产品经理🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gri.wang/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 产品经理, PM', // 网站关键词 英文逗号隔开
